...
import static utilities.ReusableMethods.takeScreenshotOfTheEntirePageAsString;
...
//        ***********ADDING CUSTOM SYSTEM INFORMATION ***********
        extentReports.setSystemInfo("Application Name", "managementonschools");
        extentReports.setSystemInfo("Test Environment","Smoke");
        extentReports.setSystemInfo("Browser","Chrome");
        extentReports.setSystemInfo("Team Name","Team01");
        extentReports.setSystemInfo("Project Name","Project11");
        //   extentReports.setSystemInfo("Feature Number","FE1056");
//        ***********DOCUMENT INFORMATION************************
        extentSparkReporter.config().setReportName("My Smoke Test Report");
